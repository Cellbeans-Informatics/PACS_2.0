...
function ViewerLayout({
  ...
  const toggleDivWidth = () => {
    console.log('hi clickeddddddddddddddddddddddddddddddddddddddddddddddddddd');
    setIsSecondDivOpen(prevState => !prevState);
  };

  return (
    <div style={{ display: 'flex', flexDirection: 'row' }}>
      <div style={{ width: isSecondDivOpen ? '50%' : '100%' }}>
        <ViewerHeader
            ...
            {rightPanelComponents.length ? (
              <ErrorBoundary context="Right Panel">
                <SidePanelWithServices
                  ...
                  servicesManager={servicesManager}
                  toggleDivWidth={toggleDivWidth} // Pass the function as a prop
                />
              </ErrorBoundary>
            ) : null}
      ...
      >
        ...
        {/* Button to toggle the div widths */}
        <div style={{ marginTop: '150px', marginLeft: '50px' }}>
          {/* Select dropdown button with a label */}
          <label
            htmlFor="reportDropdown"
          ...
          <select
            ...
            onChange={e => {
              ...
              // Add your logic or state updates based on the selected option
