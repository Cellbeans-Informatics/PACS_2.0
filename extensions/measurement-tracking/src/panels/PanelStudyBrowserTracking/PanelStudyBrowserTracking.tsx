...
// import Rectangle from '../../../../../platform/ui/src/assets/svgs/Rectangle.svg';
...
function PanelStudyBrowserTracking({
    ...
    async function fetchStudiesForPatient(StudyInstanceUID) {
      ...
      const actuallyMappedStudies = mappedStudies.map(qidoStudy => {
        return {
          ...
          modalities: qidoStudy.ModalitiesInStudy,
          numInstances: qidoStudy.NumInstances,
          patientName: qidoStudy.PatientName, // Extracting patient name
        };
      });
      ...
      // Set the patient name from the first study
      setNamePatient(actuallyMappedStudies[0]?.patientName || '');
    }
  ...
  const scrollbarStyle = {
    'scrollbar-color': '#313131', // Change the color to your desired value
  ...
  const conditionIsNormal = () => {
    console.log('chekced');
  };

  const handleConditionChange = () => {
    console.log('chekced input');
  };

  return (
    <div>
      <div className="space-title">
        <div className="textName">{namePatient}</div>
      </div>

      <div className="space-timeline">
        <div className="texttimeline">TIMELINE</div>
      </div>
      <div className="space-date">
        <div className="textdate">03-12-2023 06:30PM</div>
      </div>
      <div className="new-row">
        {/* Adjust styles based on your specifications */}
        <div
          style={{
            width: '190px',
            height: '3px',
      ...
      <div className="space-dx">
        <div className="textdx">DX</div>
        <div className="textseries">
          <div style={{ marginRight: '10px' }}>
            <label>
              <input
                type="checkbox"
                // checked={conditionIsNormal()}
                onChange={handleConditionChange}
              />
              <span style={{ marginLeft: '5px' }}>All Series</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="space-dx">
        <div className="textdx">Condition :</div>
        <div className="textseries">
          <div style={{ marginRight: '10px' }}>
            <div style={{ marginRight: '10px' }}>
              <label>
