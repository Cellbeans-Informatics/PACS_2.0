...
class SelectDisselectImagesSeriesTool extends BaseTool {
...
SelectDisselectImagesSeriesTool.toolName = 'SelectDisselectImagesSeriesTool';
export default SelectDisselectImagesSeriesTool;