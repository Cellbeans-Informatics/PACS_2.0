...
class SelectDisselectAllSeriesTool extends BaseTool {
...
SelectDisselectAllSeriesTool.toolName = 'SelectDisselectAllSeries';
export default SelectDisselectAllSeriesTool;