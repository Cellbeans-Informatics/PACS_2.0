import {
  ...
  SphereScissorsTool,
  // Added Planar Rotate tool,AdvancedMagnifyTool, ScaleOverlayTool
  PlanarRotateTool,
  AdvancedMagnifyTool,
  ScaleOverlayTool,
...
export default function initCornerstoneTools(configuration = {}) {
  ...
  // Added PlanarRotateTool, AdvancedMagnifyTool
...
const toolNames = {
  ...
  PlanarRotateTool: PlanarRotateTool.toolName,
  AdvancedMagnifyTool: AdvancedMagnifyTool.toolName,
  ScaleOverlayTool: ScaleOverlayTool.toolName,
  // Added custom text tool
};
