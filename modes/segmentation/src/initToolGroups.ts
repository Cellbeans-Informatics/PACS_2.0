...
function createTools(utilityModule) {
  ...
  return {
    active: [
      ...
      // Changes
      {
        toolName: toolNames.Probe, bindings: [{ mouseButton: Enums.MouseBindings.Primary }],
      },
      {
        toolName: toolNames.CobbAngle, bindings: [{ mouseButton: Enums.MouseBindings.Primary }],
      },
      // {
      //   toolName: toolNames.PlanarRotate, bindings: [{ mouseButton: Enums.MouseBindings.Auxiliary }],
      // },
    ],
