...
const toolbarButtons: Button[] = [
      ...
      commands: [
        {
          ...
          commandOptions: {
            toolName: 'PlanarFreehandROI',
            // interpolation: { interpolateOnAdd: true, interpolateOnEdit: true  }
          },
          context: 'CORNERSTONE',
        },
      ],
  ...
  // Custom LocalizerFirstToLast
  {
    id: 'LocalizerFirstToLast',
    type: 'ohif.action',
    props: {
      type: 'action',
      icon: 'mm-localizerfirsttolast',
  ...
  },
  {
    ...
    props: {
      type: 'action',
      icon: 'mm-select-disselect-series',
  ...
  },
  {
    ...
    props: {
      type: 'action',
      icon: 'mm-select-disselect-img-series',
...

  {
    ...
    props: {
      type: 'action',
      icon: 'mm-cardiothoraricrotation',
