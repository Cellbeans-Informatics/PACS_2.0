...
const StudyBrowser = ({
  ...
  ::-webkit-scrollbar-thumb {
    background-color: #666666;  // Set the desired color for the scrollbar thumb
  }

  // ::-webkit-scrollbar-track {
  //   background-color: #2F2F2F;  // Set the desired color for the scrollbar track
  // }
`;
