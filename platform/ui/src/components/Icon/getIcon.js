...
import iconToolMissing from './../../assets/icons/icon-tool-missing.svg';
...
// TODO adding custom icons of Medimaze
import mmAddMedia from './../../assets/mm-icons/mm-add-media.svg';
import mmBookmark from '../../assets/mm-icons/iconmonstr-star-5.svg';
import mmCrop from './../../assets/mm-icons/iconmonstr-crop-6.svg';
import mmCurveArrowRight from './../../assets/mm-icons/vector-line-curve-svgrepo-com.svg';
import mmImageMensuration from './../../assets/mm-icons/mm-image-mensuration.svg';
import mmLink from './../../assets/mm-icons/mm-link.svg';
import mmSave from '../../assets/mm-icons/iconmonstr-save-14.svg';
import mmText from './../../assets/mm-icons/mm-text.svg';
import mmClose from '../../assets/mm-icons/iconmonstr-x-mark-7.svg';
import mmDelete from '../../assets/mm-icons/mm-delete.svg';
import mmTransferData from './../../assets/mm-icons/mm-transfer-data.svg';
import mmZoom from '../../assets/mm-icons/mm-magnifier.svg';
import Medim from './../../assets/icons/Medim.svg';
import mmPrint from '../../assets/mm-icons/iconmonstr-printer-4.svg';
import mmHU from './../../assets/mm-icons/mm-HU.svg';
import mmT from './../../assets/mm-icons/mm-T.svg';
import mmEllipse from './../../assets/mm-icons/mm-ellipse.svg';
import mmHistory from './../../assets/mm-icons/iconmonstr-time-17.svg'
import mmForward from './../../assets/mm-icons/mm-forward.svg'
import mmBackward from './../../assets/mm-icons/mm-backward.svg';
import mmReport from '../../assets/mm-icons/iconmonstr-note-14.svg';
import mmAssign from '../../assets/mm-icons/iconmonstr-magnifier-text-lined.svg';
import mmToggle from '../../assets/mm-icons/iconmonstr-control-panel-6.svg'
import mmSelectDisselectSeries from  '../../assets/mm-icons/iconmonstr-text-bullet-list-lined.svg';
import mmSelectDisselectImgSeries from  '../../assets/mm-icons/iconmonstr-picture-thin.svg';
import mmSendData from '../../assets/mm-icons/iconmonstr-paper-plane-7.svg';
import mmCopyImage from '../../assets/mm-icons/iconmonstr-copy-7.svg';
import mmQuality from '../../assets/mm-icons/iconmonstr-product-10.svg';
import mmTriangulation from  '../../assets/mm-icons/iconmonstr-pen-15.svg';
import mmTextPointer from '../../assets/mm-icons/iconmonstr-text-2.svg';
import mmCardioThoraricRotation from  '../../assets/mm-icons/iconmonstr-gallery-horizontal-filled.svg';
import mmLocalizerAll from '../../assets/mm-icons/iconmonstr-accessibility-lined.svg';
import mmLocalizerFirstToLast from '../../assets/mm-icons/iconmonstr-accessibility-filled.svg';
import mmLocalizerCurrent from '../../assets/mm-icons/iconmonstr-accessibility-circle-lined.svg';
import mmMore from '../../assets/mm-icons/iconmonstr-door-5.svg';
import mmPointer from '../../assets/mm-icons/iconmonstr-arrow-up-thin.svg';
...
const ICONS = {
  ...
  'icon-tool-missing': iconToolMissing,
  ...
  // Medimaze Icons
  'mm-add-media': mmAddMedia,
  'mm-bookmark': mmBookmark,
  'mm-copy-image': mmCopyImage,
  'mm-crop': mmCrop,
  'mm-curve-arrow-right': mmCurveArrowRight,
  'mm-image-mensuration': mmImageMensuration,
  'mm-link': mmLink,
  'mm-save': mmSave,
  'mm-text': mmText,
  'mm-close': mmClose,
  'mm-transfer-data': mmTransferData,
  'mm-delete': mmDelete,
  'mm-print': mmPrint,
  'mm-zoom':mmZoom,
  'mm-hu': mmHU,
  'mm-t': mmT,
  'mm-ellipse': mmEllipse,
  'mm-history': mmHistory,
  'mm-forward': mmForward,
  'mm-backward': mmBackward,
  'mm-report':mmReport,
  'mm-assign': mmAssign,
  'mm-select-disselect-series': mmSelectDisselectSeries,
  'mm-select-disselect-img-series': mmSelectDisselectImgSeries,
  'mm-toggle':mmToggle,
  'mm-send-data': mmSendData,
  'mm-quality': mmQuality,
  'mm-triangulation': mmTriangulation,
  'mm-textpointer': mmTextPointer,
  'mm-cardiothoraricrotation': mmCardioThoraricRotation,
  'mm-localizerall': mmLocalizerAll,
  'mm-localizerfirsttolast': mmLocalizerFirstToLast,
  'mm-localizercurrent': mmLocalizerCurrent,
  'mm-more': mmMore,
  'mm-pointer':mmPointer,
};
