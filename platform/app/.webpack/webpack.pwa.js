  ...
  const mergedConfig = merge(baseConfig, {
    ...
    resolve: {
      modules: [
        ...
        path.resolve(__dirname, '../../../node_modules'),
        SRC_DIR,
        path.resolve(__dirname, 'mm-mode/my-mode/node_modules'),
        path.resolve(
          __dirname,
          'C:/Users/Krsnaa/Desktop/workspace/viewers-dev/medimaze/medimaze-mode/node_modules'
        ),
        path.resolve(__dirname, 'medimaze/medimaze-mode/node_modules'),
        path.resolve(
          __dirname,
          'D:/Medimaze/GunjanLatestCode05-12-2023/pacs_server/modes/mode-medimaze/node_modules'
        ),
        path.resolve(
          __dirname,
          'D:/Medimaze/GunjanLatestCode05-12-2023/pacs_server/extensions/medimaze-extension/node_modules'
        ),
        path.resolve(__dirname, 'modes/mode-medimaze/node_modules'),
      ],
    },
    plugins: [
      new Dotenv(),
